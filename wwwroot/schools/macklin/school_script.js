...
var footer_data = ' <p class="float-right"><a href="#">Back to top</a></p>';
    footer_data += '<p style="text-align:left;">Macklin School</p>';
    footer_data += '<address style="text-align:left;">';
...
var general_school_grad_message = 'Here are graduates from '+school_name+' in the 2020-2021 school year.';
